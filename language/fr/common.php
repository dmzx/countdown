...
$lang = array_merge($lang, array(
	...
	'ACP_COUNTDOWN_CONFIG'				=> 'Compte à rebours pour phpBB',
	'ACP_COUNTDOWN_CONFIG_EXPLAIN'		=> 'Page de configuration l’extension « PhpBB Countdown » créée par <a href="http://www.dmzx-web.net"><strong>dmzx</strong></a>. Author Stoker.',
	...
	'COUNTDOWN_DATE_EXPLAIN'			=> 'Exemple : 00:00:00 31/12/2015.',
	'COUNTDOWN_TEXT' 					=> 'Texte du compte à rebours',
	'COUNTDOWN_TEXT_EXPLAIN'			=> 'Le texte apparaîtra avant le compte à rebours. Vous pouvez utiliser HTML.',
	'COUNTDOWN_COMPLETE'	 			=> 'Texte de la fin du compte à rebours',
	'COUNTDOWN_COMPLETE_EXPLAIN' 		=> 'Ce texte remplacera le compte à rebours une fois ce dernier terminé. Vous pouvez utiliser HTML.',
	'COUNTDOWN_TESTMODE' 				=> 'Mode de test',
	'COUNTDOWN_TESTMODE_EXPLAIN'		=> 'Si activé, uniquement les administrateurs peuvent voir le compte à rebours.',
	'COUNTDOWN_YEAR'	 				=> 'Années',
	'COUNTDOWN_YEAR_EXPLAIN' 			=> 'Si activé, les années seront affichées dans le compte à rebours.',
	'COUNTDOWN_MONTH'	 				=> 'Mois',
	'COUNTDOWN_MONTH_EXPLAIN' 			=> 'Si activé, les mois seront affichés dans le compte à rebours.',
	'COUNTDOWN_OFFSET_ENABLE' 			=> 'Fuseau horaire',
	...
	'COUNTDOWN_OFFSET_EXPLAIN'			=> 'Si vous souhaitez utiliser un fuseau horaire particulier pour tous les utilisateurs vous pouvez le saisir ici :<br />Comme « UTC+04:00 » pour Océan Indien/Réunion ou encore « UTC-04:00 » pour Amérique/Guadeloupe.',
));
